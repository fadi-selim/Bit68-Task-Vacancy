...
import { View , StyleSheet , TouchableOpacity ,Dimensions, Text ,ImageBackground , Image } from 'react-native';
import { Ionicons,MaterialIcons} from '@expo/vector-icons';
import {color} from './../Colors.js'
function AddButton(props) {
  if (props.pressed)
  {return <Image style={{width:34,height:34}} source={require('./../icons/checked.png')}/>}
  else {return <Image style={{width:34,height:34}} source={require('./../icons/add.png')}/>}
